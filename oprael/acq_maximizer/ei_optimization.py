...
from oprael.acquisition_function.acquisition import AbstractAcquisitionFunction
from oprael.utils.config_space import get_one_exchange_neighbourhood, \
    Configuration, ConfigurationSpace
from oprael.acq_maximizer.random_configuration_chooser import ChooserNoCoolDown, ChooserProb
from oprael.utils.history import History, MultiStartHistory
...
class AcquisitionFunctionMaximizer(object, metaclass=abc.ABCMeta):
    ...
    def maximize(
        ...
        Parameters
        ----------
        runhistory: oprael.utils.history.History
            runhistory object
        num_points: int
        ...
        **kwargs
        ...
        -------
        iterable
            An iterable consisting of :class:`oprael.config_space.Configuration`.
        """
    ...
    def _maximize(
        ...
        **kwargs
        ...
        iterable
            ...
            tuple(acqusition_value, :class:`oprael.config_space.Configuration`).
        """
...
class LocalSearch(AcquisitionFunctionMaximizer):
    """Implementation of oprael's local search.
...
class InterleavedLocalAndRandomSearch(AcquisitionFunctionMaximizer):
    """Implements oprael's default acquisition function optimization.
    ...
    def maximize(
        ...
        num_points: int
            number of points to be sampled
        random_configuration_chooser: ~oprael.acq_maximizer.random_configuration_chooser.RandomConfigurationChooser
        ...
        **kwargs
        ...
        -------
        Iterable[Configuration]
            to be concrete: ~oprael.ei_optimization.ChallengerList
        """
        ...
        # of oprael. As long as the random forest predicts constant value, we
    ...
    def maximize(
        ...
        **kwargs
        ...
        iterable
            ...
            tuple(acqusition_value, :class:`oprael.config_space.Configuration`).
        """
        from oprael.utils.samplers import SobolSampler
