...
from oprael.utils.constants import SUCCESS
from oprael.utils.config_space.util import convert_configurations_to_array
from oprael.utils.config_space.space_utils import get_config_from_dict, get_config_values, get_config_numerical_values
from oprael.utils.transform import get_transform_function
from oprael.utils.multi_objective import get_pareto_front, Hypervolume
from oprael.utils.util_funcs import transform_to_1d_list, deprecate_kwarg
...
class History(object):
    ...
    def _get_transformed_values(self, attr: str, transform: str, warn_invalid_value: bool = True) -> np.ndarray:
        ...
        transform: str
            ...
            - Others: Use transform function in `oprael.utils.transform.get_transform_function`.
    ...
    def get_importance(self, method='fanova', return_dict=False):
        ...
        """
        from prettytable import PrettyTable
        from oprael.utils.feature_importance import get_fanova_importance, get_shap_importance
    ...
    def plot_convergence(self, true_minimum=None, name=None, clip_y=True,
        ...
        For other parameters, see `plot_convergence` in `oprael.visualization`.
        ...
        ax : matplotlib.axes.Axes
            The matplotlib axes.
        """
        from oprael.visualization import plot_convergence
        if self.num_objectives > 1:
    ...
    def plot_pareto_front(self, title="Pareto Front", ax=None, alpha=0.3, color='C0', infeasible_color='C1', **kwargs):
        ...
        Parameters
        ----------
        see `plot_pareto_front` in `oprael.visualization`.
        ...
        ax : matplotlib.axes.Axes
            The matplotlib axes.
        """
        from oprael.visualization import plot_pareto_front
        assert self.num_objectives > 1
    ...
    def plot_hypervolumes(self, optimal_hypervolume=None, ref_point=None, logy=False, ax=None, **kwargs):
        ...
        For other parameters, see `plot_curve` in `oprael.visualization`.
        ...
        ax : matplotlib.axes.Axes
            The matplotlib axes.
        """
        from oprael.visualization import plot_curve
    ...
    def visualize_html(self, open_html=True, show_importance=False, verify_surrogate=False, optimizer= None, **kwargs):
        """
        Visualize the history using oprael's HTML visualization.
        ...
        kwargs: dict
            Other keyword arguments passed to `build_visualizer` in `oprael.visualization`.
        """
        from oprael.visualization import build_visualizer, HTMLVisualizer
    ...
    def visualize_hiplot(self, html_file: Optional[str] = None, **kwargs):
        ...
        """
        from oprael.visualization import visualize_hiplot
