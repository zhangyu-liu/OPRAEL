...
from oprael.acquisition_function.acquisition import AbstractAcquisitionFunction, Uncertainty
from oprael.surrogate.base.base_model import AbstractModel
from oprael.surrogate.base.gp import GaussianProcess
from oprael.utils.platypus_utils import set_problem_types, get_variator
...
class MESMO(AbstractAcquisitionFunction):
    ...
    def __init__(self,
        ...
        config_space : oprael.space.Space
            Configuration space
        sample_num : int
...
class USeMO(AbstractAcquisitionFunction):
    ...
    def __init__(self,
        ...
        random.seed(self.rng.randint(MAXINT))
        self.config_space = config_space
        from oprael.core.base import build_acq_func
