...
from oprael.utils.util_funcs import check_random_state
from oprael.utils.history import History
...
class BOBase(object, metaclass=abc.ABCMeta):
    ...
    def get_history(self) -> History:
        assert self.config_advisor_list is not None
        return self.config_advisor_list[0].history
